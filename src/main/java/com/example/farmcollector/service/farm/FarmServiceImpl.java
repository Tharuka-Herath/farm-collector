...
public class FarmServiceImpl implements FarmService {
     ...
     */
    @Override
    public FarmDTO saveFarmAndFarmer(FarmDTO farmDTO) {
        ...
        List<Farmer> farmersList = farmDTO.getFarmers();

        for (Farmer farmer : farmersList) {
            farmer.setFarmerId(IdGenerator.generateFarmerId());
            farmer.setFarm(farmEntity);
        }
        farmEntity.setFarmers(farmersList);
